...
const answer = await inquirer.prompt([
    ...
    {
        message: chalk.bgMagenta.bold.white("select one of the operator to perform action"),
        type: "list",
        name: "operator",
        choices: [
...
if (answer.operator === chalk.yellow.bold.yellowBright("Addition")) {
    console.log(chalk.yellow.bold.yellowBright(`${answer.firstNumber} + ${answer.secondNumber} = ${answer.firstNumber + answer.secondNumber}`));
}
else if (answer.operator === chalk.blue.bold.blueBright("Subtraction")) {
    console.log(chalk.blue.bold.blueBright(`${answer.firstNumber} - ${answer.secondNumber} = ${answer.firstNumber - answer.secondNumber}`));
}
else if (answer.operator === chalk.green.bold.greenBright("Multiplication")) {
    console.log(chalk.green.bold.greenBright(`${answer.firstNumber} * ${answer.secondNumber} = ${answer.firstNumber * answer.secondNumber}`));
}
else if (answer.operator === chalk.red.bold.redBright("Division")) {
    console.log(chalk.red.bold.redBright(`${answer.firstNumber} / ${answer.secondNumber} = ${answer.firstNumber / answer.secondNumber}`));
}
else if (answer.operator === chalk.magenta.bold.magentaBright("Modulus")) {
    console.log(chalk.magenta.bold.magentaBright(`${answer.firstNumber} % ${answer.secondNumber} = ${answer.firstNumber % answer.secondNumber}`));
}
else if (answer.operator === chalk.cyan.bold.cyanBright("Square")) {
    console.log(chalk.cyan.bold.cyanBright(`${answer.firstNumber} ** ${answer.secondNumber} = ${answer.firstNumber ** answer.secondNumber}`));
}
else {
